...
<DeprecationBox deprecated="28/5-2024" expires="28/8-2024">
	Please note that Field `manifestation.physicalDescriptions` is deprecated and will be removed. Use
	`manifestation.physicalDescription` instead.
</DeprecationBox>
