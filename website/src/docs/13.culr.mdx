...
<DescribeEnum name="CreateAccountStatus" />
...
<DescribeEnum name="DeleteAccountStatus" />
...
<DescribeEnum name="GetAccountsType" />

<InlineGraphiQL
  query={`
    mutation Example_GetAccounts($input: GetAccountsInput) {
        culr {
