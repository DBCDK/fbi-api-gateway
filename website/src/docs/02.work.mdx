...
<DeprecationBox deprecated="01/11-2023" expires="01/2-2024">
  Please note that Fields `Work.materialTypes.specific` and Work.materialTypes.general are deprecated and will be removed.
  Use `Work.materialTypes.materialTypeGeneral.display` and `Work.materialTypes.materialTypeSpecific.display` instead.
</DeprecationBox>
