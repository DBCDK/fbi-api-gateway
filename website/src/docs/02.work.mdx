...
<DeprecationBox deprecated="01/07-2023" expires="01/10-2023">
  Please note that Field `Work.workReviews` is deprecated and will be removed.
  Use `Work.relations.hasReview` instead. See [reviews](#Reviews) documentation
  for details.
</DeprecationBox>

<DeprecationBox deprecated="01/11-2023" expires="01/2-2024">
  Please note that Fields `Work.materialTypes.specific` and
  Work.materialTypes.general are deprecated and will be removed. Use
  `Work.materialTypes.materialTypeGeneral.display` and
  `Work.materialTypes.materialTypeSpecific.display` instead.
</DeprecationBox>
...
<DeprecationBox deprecated="15/11-2023" expires="15/02-2024">
  Please note that field `NumberInSeries.number` is removed and only the String
  value of `NumberInSeries.display` is returned for field `numberInSeries` in
  future
</DeprecationBox>
