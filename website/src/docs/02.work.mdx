...
## <DeprecationTitle>Universe</DeprecationTitle>

<DeprecationBorder>
  <DeprecationBox deprecated="15/12-2023" expires="15/03-2024">
    Please note that Field `Work.universe` is deprecated and will be removed. Use
    `Work.universes` instead. See [universes](#Universes) documentation
    for details.
  </DeprecationBox>
