...
If you have any ideas on how to improve the developer experience, don't hesitate to contact us at [dbc@dbc.dk](mailto:dbc@dbc.dk).
...
Please attach the query that caused the bug to the issue.
