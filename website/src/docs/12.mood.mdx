...
can be used to make a [mood search request](#h2-search-with-mood-data).

The _type_ field indicates whether
the suggestion is a title, a creator, a (mood) tag.
This can be used to explicitly search for a [title, creator or mood tags](#h2-search-with-mood-data).
