...
🔔 Get notified when the schema changes. See the [Schema Changes](#4627-h2-schema-changes-🔔-Schema-Changes-🔔) section for more

History for deprecated fields (caused breaking changes) can be found in the [changelog](#4926-h2-changelog-Changelog)
...
<Link href="http://eepurl.com/jlfdkE" animation={false} target="_blank">
  <Button > Join the update list </Button>
</Link>

<br />
<br />

For additional information about deprecation and schema changes, see the [changelog](#4926-h2-changelog-Changelog) and [deprecation](#3580-h2-deprecation-Deprecation) section
