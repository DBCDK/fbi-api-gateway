...
The changelog table contains a list of both recent and previous deprecated fields that causes breaking changes to the API. This information enables users to stay informed about any deprecations that may affect their use of the API and take appropriate action to mitigate any potential issues.
