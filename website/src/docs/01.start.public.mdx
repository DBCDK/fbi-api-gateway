...
Queries with a complexity value _below 500_ will be classified as simple queries, while those _above 500_ will be considered complex queries.

If the complexity value of the query surpasses _1000_, the query will be **rejected**.
