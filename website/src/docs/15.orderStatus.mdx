...
Orderstatus fetches the status and details of an order based on a provided order ID. OrderStatus receives a list of orderIds and returns a list with the fetched data for each orderId.
