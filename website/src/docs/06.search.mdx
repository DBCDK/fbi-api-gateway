...
<InlineGraphiQL
  query={`query Example_FilterRange($q: SearchQueryInput!, $facets: [FacetFieldEnum!]!, $facetLimit: Int!, $filters: SearchFiltersInput!) {
  search(q: $q, filters: $filters) {
    hitcount
    works(offset: 0, limit: 10) {
      titles {
...
<InlineGraphiQL
  query={`query Example_HoldingsFilters ($q: SearchQueryInput!, $offset: Int!, $limit: PaginationLimitScalar!, $filters: SearchFiltersInput!, $facets: [FacetFieldEnum!]!) {
  search(q: $q, filters: $filters) {
    hitcount
    works(offset: $offset, limit: $limit) {
      titles {
