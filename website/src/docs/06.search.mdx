...
<InlineGraphiQL
  query={`query Example_BasicSearch ($q: SearchQueryInput!, $offset: Int!, $limit: PaginationLimit!) {
      search(q: $q) {
...
<InlineGraphiQL
  query={`query Example_SearchPagination ($q: SearchQueryInput!, $offset: Int!, $limit: PaginationLimit!) {
      search(q: $q) {
        hitcount
        works(offset: $offset, limit: $limit) {
          titles {
...
<InlineGraphiQL
  query={`query Example_MultipleQSearch ($q: SearchQueryInput!, $offset: Int!, $limit: PaginationLimit!) {
    search(q: $q) {
      hitcount
      works(offset: $offset, limit: $limit) {
        titles {
...
<InlineGraphiQL
  query={`query Example_SearchFacets ($q: SearchQueryInput!, $facets: [FacetField!]!, $facetLimit: Int!) {
      search(q: $q) {
        hitcount
...
<InlineGraphiQL
  query={`query Example_SearchFilters ($q: SearchQueryInput!, $facets: [FacetField!]!, $facetLimit: Int!, $filters: SearchFiltersInput!) {
...
<InlineGraphiQL
  query={`query Example_FilterRange($q: SearchQueryInput!, $facets: [FacetField!]!, $facetLimit: Int!, $filters: SearchFiltersInput!) {
  search(q: $q, filters: $filters) {
    hitcount
    works(offset: 0, limit: 10) {
      titles {
...
<InlineGraphiQL
  query={`query Example_HoldingsFilters ($q: SearchQueryInput!, $offset: Int!, $limit: PaginationLimit!, $filters: SearchFiltersInput!, $facets: [FacetField!]!) {
  search(q: $q, filters: $filters) {
    hitcount
    works(offset: $offset, limit: $limit) {
      titles {
