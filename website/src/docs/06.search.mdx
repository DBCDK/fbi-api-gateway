...
<InlineGraphiQL
  query={`query ($q: SearchQuery!, $facetsLimit: Int!, $valuesLimit: Int!) {
    search(q: $q) {
      hitcount
...
<InlineGraphiQL
  query={`query DidYouMean($q: SearchQuery!, $limit: Int) {
  search(q: $q) {
...
<InlineGraphiQL
  query={`query ($q: SearchQuery!, $offset: Int!, $limit: PaginationLimit!, $filters: SearchFilters!) {
  search(q: $q, filters: $filters) {
    hitcount
    works(offset: $offset, limit: $limit) {
      titles {
