...
<DeprecationBox deprecated="15/03-2023" expires="15/06-2023">
  Please note that `FacetField.materialTypes` and `SearchFilters.materialTypes`
  is deprecated and will be removed. Use the new fields
  `FacetField.materialTypesSpecific` and `SearchFilters.materialTypesSpecific`
  instead.
</DeprecationBox>
