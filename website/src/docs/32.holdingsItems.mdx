...
Query and mutation fields for retrieving, adding, removing and updating holdings-items
...
<InlineGraphiQL
  query={`
    query Example_HoldingsByBibliographicRecord($agencyId: String!, $bibliographicRecordId: String!) {
      holdingsItems {
