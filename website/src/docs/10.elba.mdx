...
Use of the service will require the users municipality to be a Digital artikelservice subscriber. Users municipalityAgencyId is extracted from the provided token.
