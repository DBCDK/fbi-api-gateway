export default {
  ...
  datasources: {
    ...
    jed: {
      url:
        "http://jed-presentation-0-8-service.cisterne.svc.cloud.dbc.dk/graphql" ||
        process.env.JED_URL,
    ...
    simplesearch: {
      url:
        ...
        "http://simple-search-fbiapi-1-2.mi-staging.svc.cloud.dbc.dk/search",
    ...
    facets: {
      url:
        ...
        "http://simple-search-fbiapi-1-2.mi-staging.svc.cloud.dbc.dk/facets",
