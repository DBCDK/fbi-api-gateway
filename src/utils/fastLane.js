...
const ALLOWED_TYPES = {
  ...
  GeneralMaterialTypeCodeEnum: true,
  ...
  Suggestion: true,
  SuggestionTypeEnum: true,
  CategoryResult: true,
  WorkTitles: true,
  WorkTypeEnum: true,
  Manifestations: true,
  Identifier: true,
  IdentifierTypeEnum: true,
  Languages: true,
  Language: true,
  ...
  AccessUrlTypeEnum: true,
  FictionNonfiction: true,
  FictionNonfictionCodeEnum: true,
  Audience: true,
  ChildOrAdult: true,
  ChildOrAdultCodeEnum: true,
  SchoolUse: true,
  Range: true,
  Note: true,
  NoteTypeEnum: true,
  ...
  HoldingsResponseStatusEnum: true,
