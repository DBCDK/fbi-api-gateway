...
export const FAKE_AUDIENCE = {
  ...
  childrenOrAdults: [{ display: "Dummy til børn", code: "Dummy FOR_CHILDREN" }],
  schoolUse: [{ display: "Dummy til skolebrug", code: "Dummy FOR_SCHOOL_USE" }],
...
export const FAKE_MANIFESTATION_1 = {
  ...
  accessTypes: [
    { display: "Dummy fysisk", code: "Dummy PHYSICAL" },
    { display: "Dummy online", code: "Dummy ONLINE" },
  ],
  access: FAKE_ACCESS,
  ...
  fictionNonfiction: { display: "Dummy skønlitteratur", code: "Dummy FICTION" },
